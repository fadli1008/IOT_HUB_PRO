      ...
      <div className="p-3 border-t border-gray-800/80 space-y-2">
        <div className="flex items-center space-x-3 p-2 rounded-xl bg-gray-900/60 border border-gray-800/60">
          ...
          <div className="flex-1 truncate">
            <div className="text-xs font-bold text-gray-200 truncate">{user?.name || 'User'}</div>
            <div className="text-[10px] text-brand-400 font-mono font-semibold truncate">{user?.email || 'user@iothub.local'}</div>
          </div>
        </div>
